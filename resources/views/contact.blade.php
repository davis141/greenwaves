        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    ...
                    <p class="mb-4">Our team is here to assist you with any questions or concerns you may have. Feel free to reach out, and we'll get back to you as soon as possible.</p>
                    <form>
                        <div class="row g-3">
                            <div class="col-md-6">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 text-center text-md-end">
                    ...
                    Designed By <a class="border-bottom" href="https://htmlcodex.com">Anthony</a>
                </div>
            </div>
        </div>
    </div>
